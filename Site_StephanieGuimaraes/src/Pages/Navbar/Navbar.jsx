            ...
            <li>
              <Stack direction="row" alignItems="center" gap="8px">
                <a href="https://wa.me/5562982149782" target="_blank">
                  <WhatsApp sx={{color: "var(--primary-50)", fontSize: 30}}/>    
                </a>
                <Typography fontSize="16px" fontWeight={400} color="#676767">Contato: +55(62)982149782</Typography>
              </Stack>
            </li>
            ...
            <li>
              <Stack direction="row" alignItems="center">
                <a href="https://www.linkedin.com/in/stephanie-cardoso-guimaraes-319306107/" target="_blank">
                  <LinkedIn sx={{ color: "var(--primary-50)", fontSize: 30 }} />
                </a>
              </Stack>
            </li>
            <li>
              <Stack direction="row" alignItems="center">
                <a href="https://github.com/StephanieGuimaraes" target="_blank">
                   <GitHub sx={{color:"var(--primary-50)", fontSize: 30}}/>
                </a>
              </Stack>
            </li>
            <li>
              <Stack direction="row" alignItems="center">
                ...
                <Instagram sx={{color:"var(--primary-50)", fontSize: 30}}/>
                </a>
              </Stack>
            </li>
            <Divider orientation='vertical' variant="middle" flexItem/>
            <li>
              <Stack direction="row" alignItems="center" gap="8px"><MailOutline sx={{color:"var(--primary-50)", fontSize: 30}}/>
                <Typography fontSize="16px" fontWeight={400} color="#676767">stephanieguimaraes7@gmail.com</Typography>
              </Stack>
            </li>
          </div>
        </ul>
      ...
      <div className={`container menu ${sticky ? 'small-nav' : ''}`}>
        ...
        <div>
          <ul>
              ...
              <li className='nav-buttons'>
                <Link className='btn_primary' to='sites' smooth={true} offset={-240} duration={500}>Como funciona</Link>
              </li>
